...
def requestVideo():
    ...
    try:       
        ...
        print('line 70')
        print(os.chdir('/home/runner/work/EntertainmentNews_FromAjjtk/EntertainmentNews_FromAjjtk/thumbnailimages/'))
        print(os.getcwd())
        print('line 72')
        imagedownload = urllib.request.urlretrieve(image_url,'/home/runner/work/EntertainmentNews_FromAjjtk/EntertainmentNews_FromAjjtk/thumbnailimages/thumbnailimage.png')
